...
All WhatsApp links now produce natural, human-sounding prefilled messages.
...
| **Footer (support link)** | "WhatsApp" link in Support column | Hi! I'd like to ask about BF Suma products. |
| **Floating CTA** | "Need help? WhatsApp" button | Hi! I'd like to ask about BF Suma products. |
| **Homepage CTA** | "WhatsApp Guidance" button | Hi! I'd like to ask about BF Suma products. |
| **Blog (unavailable)** | "Ask on WhatsApp" fallback | Hi! I'd like to ask about BF Suma products. |
...
| Function | Purpose |
|----------|---------|
| `buildWhatsAppGenericInquiryMessage()` | Generic "ask about products" — footer, floating CTA, homepage |
...
All messages read naturally and vary by context. No internal tracking IDs or URL slugs leak into customer-facing messages.
