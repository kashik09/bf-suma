  ...
  return (
    <section className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-brand-700">Category discovery</p>
          <h2 className="text-xl font-bold text-slate-900 sm:text-2xl">Shop by wellness focus</h2>
          <p className="text-sm text-slate-600">Explore {categories.length} categories and narrow quickly by your current goal.</p>
        </div>
        <Link className="inline-flex items-center gap-1 text-sm font-semibold text-brand-700 hover:text-brand-800" href="/shop">
          View all
        ...
        >
          <div className="relative z-10 flex h-full min-h-44 flex-col justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-white/85">Browse all categories and refine by availability, price, and product intent.</p>
            </div>
          ...
          >
            <Card className="h-full overflow-hidden rounded-2xl p-0 ring-1 ring-slate-100 transition duration-300 hover:-translate-y-0.5 hover:shadow-card hover:ring-brand-100">
              ...
              <div className="space-y-1.5 p-4">
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Health focus</p>
