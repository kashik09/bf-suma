...
export function HomeStory() {
  return (
    <section className="grid gap-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-soft lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
      <div className="space-y-4">
        <p className="text-xs font-semibold uppercase tracking-wide text-brand-700">Our Story</p>
        <h2 className="text-2xl font-semibold text-slate-900">Built for people who want wellness products without confusion.</h2>
        ...
        <ul className="space-y-2">
          {storyPoints.map((point) => (
            <li className="flex items-start gap-2 text-sm text-slate-700" key={point}>
